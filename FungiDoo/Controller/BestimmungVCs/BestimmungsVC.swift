...
class BestimmungsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getQuestion(for: propertyCalculated)
    }
    ...
    func identificationMethods(){
        ...
        propertyCalculated = getEntropyForAllProperties(without : propertyNoCalculation)
    }
    ...
    func calcEntropyPropertiesForQuestions() {
        ...
        propertyCalculated = getEntropyForProperties(without : propertyNoCalculation)
